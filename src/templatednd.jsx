...
function App() {
  const [stores, setStores] = useState(DATA)
              ...
              // sets order for items in each list
  ...
  return (
    <div className="layout_wrapper">
      <div className='card'>
            {/* a function so we know what to do when the draggable item is dropped */}
        ...
        <Droppable droppableId='ROOT' type='group'>
          ...
          {/*placeholder to stop card shrinking while we're dragging.*/}
